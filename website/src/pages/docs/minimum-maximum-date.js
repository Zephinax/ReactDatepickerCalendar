...
import { Calendar, utils } from ' @zephinax/react-datepicker-calendar';
...
const MinimumMaximumDate = () => {
  ...
  return (
    <Docs title="Minimum & Maximum Date">
      <p>
        There are many cases where you want to somehow limit the user to choose
        a day in a appropriate range. That&#39;s when{' '}
        <code className="custom-code">minimumDate</code> and{' '}
        <code className="custom-code">mximumDate</code> props come in handy.
