...
const DisabledDays = () => {
  const [datePicker1Value, setDatePicker1Value] = useState({
    year: 2019,
    month: 3,
    day: 12,
  });
  ...
  return (
    <Docs title="Disabled Day(s)">
      <p>
        Sometimes, you need to disallow user to select some specific days.{' '}
        <code className="custom-code">disabledDays</code> prop takes an array of
        desired disabled days:
      </p>
...
PropTypes.arrayOf(PropTypes.shape({
  ...
  day: PropTypes.number.isRequired,
      ...
      <p>
        By passing disabled days, users won&#39;t be able to select a disabled
        day or include one in a range. At such times,{' '}
        <code className="custom-code">onDisabledDayError</code>
